...
def update_employee():
    ...
    if employee := Employee.find_by_id(id_):
        try:
            ...
            employee.update()
            print("Success: {employee.name}, {employee.job_title}, {employee.department_id}")   
        except Exception as exc:
    ...
    if department := Department.find_by_id(dept_id):
        ...
        if dept_employees:
            for employee in dept_employees:
                print(f"Employee {employee.id}: {employee.name}, {employee.job_title}, Department: {employee.department_id}")
        else:
            print(f'There are no employees in {department.name} department')
    else:
